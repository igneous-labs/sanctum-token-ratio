...
///
/// A zero denominator [`Self::d`] is treated as 0.
///
...
/// Associated types for a [`Ratio`] for use in arithmetic operations
///
/// (inherent associated types are still unstable)
pub trait ArithTypes {
    /// The largest bitwidth type between [`Ratio::N`] and [`Ratio::D`]
    type Max;
...
macro_rules! impl_ratio {
    ($N:ty, $D:ty, [$gcd:expr, $MAX:ty, $EXT:ty]) => {
        impl Ratio<$N, $D> {
            ...
            /// Returns `0/0` if [`Self::is_zero()`]
            #[inline]
            pub const fn lowest_form(&self) -> Ratio<$MAX, $MAX> {
                if self.is_zero() {
...
impl_ratio!(u8, u8, [gcd_u8, u8, u16]);
impl_ratio!(u8, u16, [gcd_u16, u16, u32]);
impl_ratio!(u8, u32, [gcd_u32, u32, u64]);
impl_ratio!(u8, u64, [gcd_u64, u64, u128]);

impl_ratio!(u16, u8, [gcd_u16, u16, u32]);
impl_ratio!(u16, u16, [gcd_u16, u16, u32]);
impl_ratio!(u16, u32, [gcd_u32, u32, u64]);
impl_ratio!(u16, u64, [gcd_u64, u64, u128]);

impl_ratio!(u32, u8, [gcd_u32, u32, u64]);
impl_ratio!(u32, u16, [gcd_u32, u32, u64]);
impl_ratio!(u32, u32, [gcd_u32, u32, u64]);
impl_ratio!(u32, u64, [gcd_u64, u64, u128]);

impl_ratio!(u64, u8, [gcd_u64, u64, u128]);
impl_ratio!(u64, u16, [gcd_u64, u64, u128]);
impl_ratio!(u64, u32, [gcd_u64, u64, u128]);
impl_ratio!(u64, u64, [gcd_u64, u64, u128]);
